...
DEFAULT_CLIENT_TYPE = "caldav-bridge"
    ...
    def _request(
        ...
        **kwargs: Any,
        ...
        headers = {
            ...
            "token": request_token,
            "X-Client": client_type or self.client_type,
            "X-Client-Name": client_name or self.client_name,
            **headers,
        }
        version = client_version if client_version is not None else self.client_version
        if version:
